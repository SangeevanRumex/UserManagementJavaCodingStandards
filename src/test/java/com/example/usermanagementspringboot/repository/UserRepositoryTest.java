...
class UserRepositoryTest {
    ...
    User user = new User(1,"Sangeevan","Colombo",false,
                        null);
    ...
    void save(){
        ...
        assertThat(savedUser).usingRecursiveComparison()
                .ignoringFields("id","deleted","follows").isEqualTo(user);
    }
    ...
    void getUsers(){
        ...
        assertThat(gotUsers.get(0)).usingRecursiveComparison()
                .ignoringFields("id","deleted","follows").isEqualTo(user);
    }
    ...
    void deleteUser(){
        ...
        assertThat(gotUser).usingRecursiveComparison()
                .ignoringFields("id","deleted","follows").isEqualTo(null);
    }
}